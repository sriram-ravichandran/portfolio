    ...
    return( 
      ...
      <div style={{fontSize:18,width:'90%'}} class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div  class="col-lg-4">
            <img style={{top:'15%'}} src={facee} class="container responsive my-photo" alt=""/>
          </div>
          ...
          <p>I'm a Computer Science student with 1 Year of Experience in Working in React JS Projects</p>
            ...
            <p class="fst-italic">Completed <span><strong>SSLC</strong></span> in Vivek Vidhyalaya Matric Higher Secondary School with <span><strong>91.6%</strong></span></p><br/><h3>TECHNICAL SKILLS</h3><br/>
            <div class="row">
              <div  class="col-lg-6">
                <ul>
